...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`manger`@`localhost`*/ /*!50003 TRIGGER `check_delete_order` BEFORE DELETE ON `book_orders` FOR EACH ROW begin
	update book 
    set quantity=quantity+threshold
    where old.ISBN=ISBN;
end */;;
DELIMITER ;
